...
int main()
{
	...
	plot_bitmap_32((UINT32 *)base, 0, 327, top_triangle_bitmap, HEIGHT_32);
	plot_bitmap_32((UINT32 *)base, 0, 327, bottom_triangle_bitmap, HEIGHT_32); /*Will eventuall just call plot_triangle_borders(); to loop.*/
