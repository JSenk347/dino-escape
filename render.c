    ...
    for (i = 0; i < NUM_WALLS; i++) {
        ...
        if (wall -> is_moving && (wall -> top.top_right.x < R_BORDER_X && wall -> top.top_left.x > L_BORDER_X)) {
            ...
            if (top -> prev_top_lt.x != top -> top_left.x) {
                ...
                plot_gline(bottom->top_left.x, (bottom->top_left.y) + 31, bottom->top_left.x, bottom->bot_left.y/*B_BORDER_Y - 1/*2*/, XOR);
                plot_gline((bottom->top_left.x) + 1, (bottom->top_left.y) + 31, (bottom->top_left.x) + 1, bottom->bot_left.y/*B_BORDER_Y - 1/*2*/, XOR);
                plot_gline(bottom->top_right.x, (bottom->top_right.y) + 31, bottom->top_right.x, bottom->bot_right.y/*B_BORDER_Y - 1/*2*/, XOR);
                plot_gline((bottom->top_right.x) - 1, (bottom->top_right.y) + 31, (bottom->top_right.x) - 1, bottom->bot_right.y/*B_BORDER_Y - 1/*2*/, XOR);
                /* Clear old lines - BOTTOM */
                plot_gline((bottom->top_left.x) + vel, (bottom->top_left.y) + 31, (bottom->top_left.x) + vel, bottom->bot_left.y/*B_BORDER_Y - 1/*2*/, XOR);
                plot_gline((bottom->top_left.x) + vel + 1, (bottom->top_left.y) + 31, (bottom->top_left.x) + vel + 1, bottom->bot_left.y/*B_BORDER_Y - 1/*2*/, XOR);
                plot_gline((bottom->top_right.x) + vel, (bottom->top_right.y) + 31, (bottom->top_right.x) + vel, bottom->bot_right.y/*B_BORDER_Y - 1/*2*/, XOR);
                plot_gline((bottom->top_right.x) + 1, (bottom->top_right.y) + 31, (bottom->top_right.x) + 1, bottom->bot_right.y/*B_BORDER_Y - 1/*2*/, XOR);
